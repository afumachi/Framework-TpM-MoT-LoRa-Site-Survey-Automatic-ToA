...
#---------------------- CRIAÇÃO DOS CAMPOS DE CONFIGURAÇÕES DE RÁDIO LORA ------------------------
potencia_radio = Label(reg_parametrizacao, text = "TX Power", font=("Arial", 12))
...
reg_desempenho.place(x=10,y=335,width=300,height=360)
...
reg_grafico.place(x=330, y=10, width=750, height=675) #height=790
#-------------------------------------------------------------------------------
